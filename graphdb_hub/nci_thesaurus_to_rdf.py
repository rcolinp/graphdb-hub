...
from namespaces import NAMESPACES, NCIT, SH, UMLS_STY
...
class NciToRDF:
    def __init__(self, url):
        ...
        self.graph.namespace_manager.bind("sty", UMLS_STY)
    ...
    def convert_to_rdf(self, see_also=""):
        ...
        with open("ncit_sty2.ttl", "w") as file:
